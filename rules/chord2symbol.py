...
def get_bass_chroma24(chord_notes):
    if len(chord_notes) <= 1:
        return []
    
    sorted_notes = chord_notes.sort()
    bass_note = chord_notes[0]
    bass_chroma = bass_note % 12
...
def rectify_chroma24(chroma24, reduces=DEFAULT_REDUCE, reserves=[], removes=[]):
    if len(chroma24) == 0:
        return chroma24
    new_chroma24 = []
...
def chroma24_to_interval(chroma24):
    length = len(chroma24)
    if length == 0:
        return []
    interval = [chroma24[0]]
...
''' 
def inv_invert(bass_note, chroma24):
    if len(chroma24) == 0:
        return bass_note, []
    if len(chroma24) == 1:
        return bass_note, chroma24
...
def remove_inversion(chord_quality):
    done = False
...
'''
def remove_extension(chord_quality):
    done = False
    splitted = chord_quality.split("-")
    while not done:
...
def remove_inversion_extension(chord_quality):
...
def get_extra_notes_chroma12(template, chroma12, chroma12_is_octave):
    extra_notes = []
#     print(chroma12, chroma12_is_octave)
...
def create_extension_string_from_notes(extra_notes, exts = INT2EXT):
    ext_string = ""
...
def create_extra_note_extension_chroma12(template, chroma12, chroma12_is_octave, exts = INT2EXT):
    extra_notes = []
...
def is_intervals(chroma24, chroma12 = None, chroma12_is_octave = None, inverted = False):
    if chroma12 is None:
        chroma12 = chroma24
    if chroma12_is_octave is None:
        chroma12_is_octave = [False]*len(chroma12)
    if len(chroma12) == 0:
...
def default_chroma12(chroma24, chroma12 = None, chroma12_is_octave = None):
    if chroma12 is None:
        chroma12 = chroma24
    if chroma12_is_octave is None:
        chroma12_is_octave = [False]*len(chroma12)
...
def is_major_basics(chroma24, chroma12 = None, chroma12_is_octave = None, inverted = False):
...
def is_minor_basics(chroma24, chroma12 = None, chroma12_is_octave = None, inverted = False):
    if INT_M3 not in chroma24:
        chroma12, chroma12_is_octave = default_chroma12(chroma24, chroma12, chroma12_is_octave)
...
def is_dominant_basics(chroma24, chroma12 = None, chroma12_is_octave = None, inverted = False):
    if INT_m3 not in chroma24:
        chroma12, chroma12_is_octave = default_chroma12(chroma24, chroma12, chroma12_is_octave)
...
def is_sus_basics(chroma24, chroma12 = None, chroma12_is_octave = None, inverted = False):
    chroma12, chroma12_is_octave = default_chroma12(chroma24, chroma12, chroma12_is_octave)
...
def is_aug_basics(chroma24, chroma12 = None, chroma12_is_octave = None, inverted = False):
    if INT_m3 not in chroma24:
        chroma12, chroma12_is_octave = default_chroma12(chroma24, chroma12, chroma12_is_octave)
...
def is_dim_basics(chroma24, chroma12 = None, chroma12_is_octave = None, inverted = False):
    if INT_M3 not in chroma24:
        chroma12, chroma12_is_octave = default_chroma12(chroma24, chroma12, chroma12_is_octave)
...
'''
def parse_extra_notes_sharp11(chroma24, template_core, ext_all, ext_no_sharp11, max_extra_ext = 1, collisions = [INT_11,INT_a11]):
...
def parse_extra_notes(chroma24, template_core, ext_all, max_extra_ext = 1):
    remaining_intervals = chroma24_difference(chroma24, template_core)
    ext_removed = chroma24_difference(remaining_intervals, ext_all)
    if len(ext_removed) <= max_extra_ext:
        ext_components = chroma24_difference(remaining_intervals, ext_removed)
...
ALT_REMOVES = [INT_5]
def is_alt(chroma24, chroma12 = None, chroma12_is_octave = None, inverted = False):
...
def is_triad_extensions(chroma24, chroma12 = None, chroma12_is_octave = None, inverted = False):
    if len(chroma12) == 3:
        chroma12, chroma12_is_octave = default_chroma12(chroma24, chroma12, chroma12_is_octave)
...
MAJOR_REMOVES = []
def is_major_seventh_sixth_extensions(chroma24, chroma12 = None, chroma12_is_octave = None, inverted = False):
...
MINOR_REMOVES = []
def is_minor_seventh_sixth_extensions(chroma24, chroma12 = None, chroma12_is_octave = None, inverted = False):
    is_dim_bool = bool(is_dim_basics(chroma24, chroma12, chroma12_is_octave, inverted))
...
def parse_extra_notes_dom(chroma24, template_core, max_extra_ext = 1):
    remaining_intervals = chroma24_difference(chroma24, template_core)
...
def is_dom_seventh_extensions(chroma24, chroma12 = None, chroma12_is_octave = None, inverted = False):
...
SUS_REMOVES = []
def is_sus_seventh_extensions(chroma24, chroma12 = None, chroma12_is_octave = None, inverted = False):
    # if INT_m3 not in chroma24 or (INT_M3 in chroma24 and INT_m3 in chroma24):
    if INT_m3 not in chroma24 and INT_M3 not in chroma24:
...
AUG_REMOVES = []
def is_aug_major_seventh_extensions(chroma24, chroma12 = None, chroma12_is_octave = None, inverted = False):
...
DIM_REMOVES = []
def is_dim_seventh_extensions(chroma24, chroma12 = None, chroma12_is_octave = None, inverted = False):
    if INT_M3 not in chroma24 or (INT_M3 in chroma24 and INT_m3 in chroma24):
...
HALFDIM_REMOVES = []
def is_halfdim_seventh_extensions(chroma24, chroma12 = None, chroma12_is_octave = None, inverted = False):
    if INT_M3 not in chroma24 or (INT_M3 in chroma24 and INT_m3 in chroma24):
